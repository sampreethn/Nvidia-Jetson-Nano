The **NVIDIA Jetson Orin Nano Developer Kit** is a small, powerful edge AI computer designed for prototyping entry-level AI robots, smart drones, and intelligent vision systems
Key Features include:
1. Up to 67 TOPS (Tera Operations Per Second) for INT8 inference, enhanced via recent software updates
2. GPU: NVIDIA Ampere architecture with 1,024 CUDA cores and 32 Tensor Cores.
3. CPU: 6-core Arm Cortex-A78AE v8.2 64-bit CPU.
